...
const extra9 = new random.RandomPassword("extra-9", {
    length: 24,
    special: true,
});

const extra10 = new random.RandomId("extra-10", {
    byteLength: 8,
});

const extra11 = new command.local.Command("extra-11", {
...
const extra12 = new random.RandomString("extra-12", {
    length: 32,
    special: false,
});

const extra13 = new random.RandomPassword("extra-13", {
    length: 16,
    special: true,
});

const extra14 = new random.RandomId("extra-14", {
    byteLength: 16,
});
