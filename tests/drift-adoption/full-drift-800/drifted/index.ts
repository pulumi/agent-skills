...
const randomStr286 = new random.RandomString("random-str-286", {
    length: 16,
    special: false,
});
...
const randomStr301 = new random.RandomString("random-str-301", {
    length: 16,
    special: false,
});
...
const cmd195 = new command.local.Command("cmd-195", {
    create: "echo resource-195",
});
...
const cmd269 = new command.local.Command("cmd-269", {
    create: "echo resource-269",
});
