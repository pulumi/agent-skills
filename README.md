...
| [pulumi-drift-adopt](authoring/skills/pulumi-drift-adopt) | Adopt infrastructure drift back into Pulumi code |
...
npx skills add pulumi/agent-skills/authoring      # 5 authoring skills
```
